...
public class WitcherCurioItem extends Item implements ICurioItem {
    ...
    /// Curios 5.14.1 (1.20.1): the hook is keyed by a slot-unique `UUID` and speaks in raw
    /// `EntityAttribute`s. Curios 9.x's `Identifier`-keyed / `RegistryEntry` shape is 1.21-only.
    @Override
