...
public class WitcherModelPredicates {
    public static void registerModelPredicates() {
        ...
        ModelPredicateProviderRegistry.register(aerondightItem, new Identifier(MOD_ID, "aerondight_charged"),
        ...
        ModelPredicateProviderRegistry.register(irisItem, new Identifier(MOD_ID, "iris_charged"),
                (stack, world, entity, seed) -> {
                    if (entity instanceof LivingEntity) {
                        LivingEntity living = entity;
