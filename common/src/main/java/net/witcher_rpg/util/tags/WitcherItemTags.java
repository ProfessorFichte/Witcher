...
public class WitcherItemTags {
    ...
    public static final TagKey<Item> MASTERCRAFTED_DIAGRAMS = register("mastercrafted_diagrams");
    public static final TagKey<Item> GRANDMASTER_DIAGRAMS = register("grandmaster_diagrams");
