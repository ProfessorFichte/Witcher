...
public class WitcherClassModDataGenerator implements DataGeneratorEntrypoint {
	...
	public static class LangGenerator extends FabricLanguageProvider {
		// Fabric API 0.92: `FabricLanguageProvider(FabricDataOutput, String)`; the 3-arg constructor is kept
		// so `pack.addProvider(LangGenerator::new)` still resolves as a RegistryDependentFactory.
