...
/**
 * Generates all smithing recipes for the Witcher mod.
 *
 * On 1.21.1 this extended More RPG Library's `SmithingRecipeGenerator`; on the 1.20.1 line that library
 * class still emits 1.21-shaped JSON, so the generator lives in {@link WitcherSmithingRecipeBase} here
 * instead (same call surface, same recipe ids).
 */
public class WitcherSmithingRecipeGenerator extends WitcherSmithingRecipeBase {
    ...
    private void generateSwordUpgrades() {
        ...
        createSimpleSmithingRecipe(
                ...
                new Identifier("netherite_upgrade_smithing_template"),
